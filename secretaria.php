...
if($_SESSION["DATOS_USUARIO"]["ID_PERFIL"] !== '2'){
...
<head>
  ...
  <title>CitasPro | Secretaria</title>
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Citas de pacientes</h3>
                </div>
  ...
  <script>
    $(function() {
      ...
      var tbl_paciente = $("#example1").DataTable({
        ...
        "lengthChange": true,
        "autoWidth": true,
        "ajax": "./manejadores/manejadorSecretariaCitas.php",
        "language": {
